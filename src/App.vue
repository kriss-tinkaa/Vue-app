    ...
    <v-container>
      <v-toolbar app class="lime lighten-4"> 
        ...
        <v-toolbar-items class="hidden-sm-and-down">
          ...
          <v-btn v-if="isAdmin==true" to="/create-quiz" flat>Create quiz</v-btn>
          <v-avatar v-if="loggedIn==true" color="lime" style="margin:8px 0">
            
            <img src="https://img.icons8.com/small/16/000000/user-male-circle.png" style="width:24px; height:24px;"/>
          </v-avatar>
